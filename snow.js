...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'snow.data';
    var REMOTE_PACKAGE_BASE = 'snow.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_snow.data');

    };
    Module['addRunDependency']('datafile_snow.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'snow.wast';
  var wasmBinaryFile = 'snow.wasm';
  var asmjsCodeFile = 'snow.temp.asm.js';
