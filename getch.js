...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'getch.data';
    var REMOTE_PACKAGE_BASE = 'getch.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_getch.data');

    };
    Module['addRunDependency']('datafile_getch.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'getch.wast';
  var wasmBinaryFile = 'getch.wasm';
  var asmjsCodeFile = 'getch.temp.asm.js';
