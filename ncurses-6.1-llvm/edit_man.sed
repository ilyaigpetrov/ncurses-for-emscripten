...
s/\<fBnew_pair\\fR(3X)/fBnew_pair\\fR(3NCURSES)/
...
s/\<fBscr_dump\\fR(5)/fBscr_dump\\fR(5)/
...
s/\<fBuser_caps\\fR(5)/fBuser_caps\\fR(5)/
...
s/\<fBvprintf\\fR(3)/fBvprintf\\fR(3)/
...
s/^\\fBnew_pair\\f[RP] -/\\fBnew_pair\\fR -/
...
s/^\\fBscr_dump\\f[RP] -/\\fBscr_dump\\fR -/
...
s/^\\fBuser_caps\\f[RP] -/\\fBuser_caps\\fR -/
