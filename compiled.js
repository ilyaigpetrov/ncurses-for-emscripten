...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'compiled.data';
    var REMOTE_PACKAGE_BASE = 'compiled.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_compiled.data');

    };
    Module['addRunDependency']('datafile_compiled.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'compiled.wast';
  var wasmBinaryFile = 'compiled.wasm';
  var asmjsCodeFile = 'compiled.temp.asm.js';
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iii": nullFunc_iii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_vi": nullFunc_vi, "invoke_ii": invoke_ii, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_vi": invoke_vi, "___buildEnvironment": ___buildEnvironment, "___lock": ___lock, "___map_file": ___map_file, "___setErrNo": ___setErrNo, "___syscall132": ___syscall132, "___syscall140": ___syscall140, "___syscall142": ___syscall142, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "___syscall183": ___syscall183, "___syscall195": ___syscall195, "___syscall20": ___syscall20, "___syscall221": ___syscall221, "___syscall3": ___syscall3, "___syscall33": ___syscall33, "___syscall4": ___syscall4, "___syscall41": ___syscall41, "___syscall5": ___syscall5, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___syscall91": ___syscall91, "___unlock": ___unlock, "___wait": ___wait, "__exit": __exit, "_abort": _abort, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_exit": _exit, "_fpathconf": _fpathconf, "_getenv": _getenv, "_gettimeofday": _gettimeofday, "_kill": _kill, "_nanosleep": _nanosleep, "_setenv": _setenv, "_sigaction": _sigaction, "_sigaddset": _sigaddset, "_sigemptyset": _sigemptyset, "_sigismember": _sigismember, "_signal": _signal, "_sigprocmask": _sigprocmask, "_time": _time, "_times": _times, "_usleep": _usleep, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
